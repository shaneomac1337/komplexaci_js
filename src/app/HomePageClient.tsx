...
export default function HomePageClient({
  ...
  return (
    <>
      ...
      {/* Contact Section */}
      <section id="kontakt" className="community-redesign section-heading-redesign contact-redesign">
        <div className="community-bg" aria-hidden="true">
          <div className="community-bg-image" />
          <div className="community-grid" />
        </div>
        ...
        <div className="community-shell">
          <header className="community-header">
            ...
            <div className="community-heading-row">
              <h2>Napiš <span>nám</span></h2>
              <p>
                Chceš se přidat do klanu nebo máš dotaz? Hoď zprávu — odpovídáme rychle. Najdeš nás taky na sociálních sítích.
              </p>
            </div>
          </header>
          ...
          <div className="contact-stack">
            <div className="contact-primary-grid">
              <a href="mailto:info@komplexaci.cz" className="contact-tile contact-tile--email">
                <span className="contact-tile-aurora" aria-hidden="true" />
                <div className="contact-tile-head">
                  ...
                  <span className="contact-tile-kicker">Napiš e-mail</span>
                </div>
                <div className="contact-tile-body">
                  <strong>info@komplexaci.cz</strong>
                  <span className="contact-tile-meta">
                    <span className="community-live-dot" />
                    Ozveme se obvykle do 24 h
                  </span>
                </div>
                <span className="contact-tile-action">
                  Otevřít e-mail
                  <span className="contact-tile-arrow">→</span>
                </span>
              </a>

              <a href="https://discord.gg/eoBCQpQRDA" target="_blank" rel="noopener noreferrer" className="contact-tile contact-tile--discord">
                <span className="contact-tile-aurora" aria-hidden="true" />
                <div className="contact-tile-head">
                  <span className="contact-tile-icon">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="contact-tile-kicker">Připoj se</span>
                </div>
                <div className="contact-tile-body">
                  <strong>Discord komunita</strong>
                  <span className="contact-tile-meta">
                    <span className="community-live-dot" />
                    Diskuze · music bot · live stats
                  </span>
                </div>
                <span className="contact-tile-action">
                  Otevřít pozvánku
            ...
            <a href="/videotvorba" className="contact-secondary">
              <span className="contact-secondary-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </span>
              <div className="contact-secondary-copy">
                <strong>Naše Videotvorba</strong>
              </div>
              <span className="contact-tile-arrow">→</span>
            </a>

            <div className="contact-socials">
              <span className="contact-socials-label">— Najdeš nás taky —</span>
              <div className="contact-socials-icons">
                <a href="https://www.youtube.com/user/Mercin1000" target="_blank" rel="noopener noreferrer" className="contact-social" aria-label="YouTube">
                  <svg viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                <a href="https://www.twitch.tv/shanemc1337" target="_blank" rel="noopener noreferrer" className="contact-social" aria-label="Twitch">
                ...
                <a href="https://www.instagram.com/m_penkava/" target="_blank" rel="noopener noreferrer" className="contact-social" aria-label="Instagram">
                ...
                <a href="https://x.com/mpenkava1337" target="_blank" rel="noopener noreferrer" className="contact-social" aria-label="X">
                  <svg viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="https://www.facebook.com/penkava.martin" target="_blank" rel="noopener noreferrer" className="contact-social" aria-label="Facebook">
